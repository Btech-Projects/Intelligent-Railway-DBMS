CREATE DATABASE IF NOT EXISTS `id13688819_railway` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `id13688819_railway`;
...
create table pnr_details(pnr int,seat_no int auto_increment,key(seat_no));
...
create table cancelled(pnr int,fare int, Foreign Key(pnr) references ticket(pnr));
